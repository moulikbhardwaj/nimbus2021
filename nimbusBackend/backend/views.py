...
from backend.models import Department, User, Quiz, Question
...
from backend.serializers import DepartmentSerializer, UserSerializer, QuizSerializer, QuestionSerializer
